...
// ---------- Public / Leader / Admin ----------
app.get("/public/online", async (req, res) => {
...
// Admin: payroll (VND)
app.get("/admin/payroll", auth, requireRole(["admin"]), async (req, res) => {
...
app.get("/admin/online", (req, res) =>
  res.sendFile(path.join(process.cwd(), "public", "online.html"))
);
app.get("/admin/payroll", (req, res) =>
  res.sendFile(path.join(process.cwd(), "public", "payroll.html"))
);
